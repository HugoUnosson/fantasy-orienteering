...
const Navbar = () => {
  ...
  // TODO Should probably refactor this so the code gets a bit prettier 
  // If there is no user, use this navbar
  if (!user) {
    return (
    ...
    <nav className="bg-slate-900 text-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* 2. Desktop Menu (Hidden on mobile) */}
          <div className="hidden md:flex space-x-6 items-center">
            <NavLink to="/dashboard" className="hover:text-emerald-400 transition-colors">Home</NavLink>
            <NavLink to="/team" className="hover:text-emerald-400 transition-colors">Team</NavLink>
            <NavLink to="/leaderboard" className="hover:text-emerald-400 transition-colors">Leaderboard</NavLink>
            <NavLink to="/account" className="hover:text-emerald-400 transition-colors">""name""</NavLink>
